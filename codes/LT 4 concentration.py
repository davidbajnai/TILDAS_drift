...
INPUT:
- LT Table S3.csv: A CSV file containing data from the University of Cape Town.
- LT Table S4.csv: A CSV file containing data from the University of Göttingen.
...
df_uct = pd.read_csv(os.path.join(data_dir, "LT Table S3.csv"))
df_uct['pCO2Mismatch'] = df_uct['mean_CO2_L2'] - 421
df_uct["Dp17O"] = df_uct['mean_Dp17OL2']*1000
...
plt.savefig(os.path.join(figures_dir, "LT Figure 3.png"))
plt.close("all")